...
![Task distribution by status and priority](assets/task_breakdown.png)
...
<details open>
<summary><strong>Estimation Accuracy</strong></summary>
...
![Estimated vs actual hours per team member](assets/hours_comparison.png)
